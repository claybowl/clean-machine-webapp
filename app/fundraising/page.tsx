...
export default function FundraisingPage() {
  ...
  const donationTiers = [
    ...
    },
    {
      ...
      perks: ["All Supporter rewards", "30-minute AI consultation", "Access to our prompt library"],
    },
    {
      name: "Business",
      amount: 500,
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-[#FF7F00] hover:bg-[#FF7F00]/90 text-white" asChild>
                <a href="https://donate.stripe.com/3csfZe65v71A10s5km" target="_blank" rel="noopener noreferrer">
                  Donate Now
      ...
      <section className="py-12 bg-white">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="max-w-4xl mx-auto">
            ...
            {/* QR Code */}
            <div className="flex flex-col md:flex-row gap-8 items-center bg-gray-50 rounded-xl p-6 mb-12">
              <div className="md:w-1/3 flex justify-center">
                <div className="bg-[#6366F1] p-6 rounded-xl shadow-md max-w-xs">
                  <img src="/images/donation-qr-code.png" alt="Donation QR Code" className="w-full h-auto" />
                  <p className="text-white text-center text-xl mt-4 font-medium">Scan to donate</p>
                  <p className="text-white/80 text-center text-sm mt-1">
                    Or visit:{" "}
                    <a
                      href="https://donate.stripe.com/3csfZe65v71A10s5km"
                      className="underline"
                      target="_blank"
                ...
                <Card key={tier.name} className="flex flex-col border-2 hover:border-[#0076FF] transition-all">
                  <CardContent className="flex flex-col flex-grow p-6">
                    ...
                    <Button className="w-full bg-[#0076FF] hover:bg-[#0076FF]/90 text-white" asChild>
                      <a
                        href={`https://donate.stripe.com/3csfZe65v71A10s5km?amount=${tier.amount * 100}`}
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        Donate ${tier.amount}
